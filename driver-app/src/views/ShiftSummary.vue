...
const summaryStats = [
    ...
    { label: 'On-Time', icon: 'schedule', value: '96%', sub: '+2 from avg', color: 'text-primary' },
    { label: 'COD Collected', icon: 'payments', value: '₹3,650', sub: '3 payments', color: 'text-accent-gold' },
    { label: 'Distance', icon: 'timeline', value: '47 km', sub: 'Shift total', color: 'text-accent-blue' },
    { label: 'Fuel Used', icon: 'local_gas_station', value: '4.2 L', sub: '88 km/L avg', color: 'text-signal-amber' },
    { label: 'Streak', icon: 'local_fire_department', value: '14 days', sub: 'Zero deviation', color: 'text-red-400' },
]
