                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <button v-for="cond in ['Unopened', 'New/Open Box', 'Damaged', 'Defective', 'Scrap']" :key="cond"
                                        ...
                                        :class="processForm.condition === cond ? 'bg-primary text-white border-primary' : 'bg-slate-800 text-gray-300 border-white/10 hover:border-primary/40'">
                                        {{ cond }}
                                    </button>
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 filter" :class="!conditionVerified ? 'grayscale opacity-50 pointer-events-none' : ''">
                                <div>
                                    ...
                                    <select v-model="processForm.action" @change="updateRefundAmount" class="w-full bg-slate-800 border border-white/10 rounded-lg px-3 py-2 text-sm text-white outline-none focus:ring-2 focus:ring-primary/50">
                            ...
                            <div>
                                ...
                                <textarea v-model="processForm.notes" rows="2" placeholder="Add inspection notes..." class="w-full bg-slate-800 border border-white/10 rounded-lg px-3 py-2 text-sm text-white placeholder:text-slate-400 outline-none focus:ring-2 focus:ring-primary/50"></textarea>
                            </div>
                        </div>
                    </div>
