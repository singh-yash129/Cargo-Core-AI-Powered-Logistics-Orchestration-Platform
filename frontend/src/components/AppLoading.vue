    ...
    <Transition name="loading-fade">
        <div v-if="visible"
            ...
            <div class="absolute inset-0 pointer-events-none overflow-hidden opacity-20">
                <div class="w-[700px] h-[700px] bg-primary/30 rounded-full blur-[120px] absolute -top-40 -left-60">
                </div>
                <div class="w-[500px] h-[500px] bg-blue-500/20 rounded-full blur-[100px] absolute -bottom-40 -right-60">
                </div>
            </div>
