    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-3">
                    <div v-for="slot in dockSchedule" :key="slot.id" @click="selectedSlot = slot; showSlotDetail = true"
                        ...
                        <div class="flex justify-between mb-1">
                            <span :class="slot.status === 'Completed' ? 'text-gray-600 dark:text-gray-400' : 'text-primary'"
                        ...
                        <div class="text-xs text-gray-600 dark:text-gray-400">{{ slot.dock }} • {{ slot.pallets }} Pallets</div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2 glass-panel rounded-xl overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-white/5 font-bold text-gray-900 dark:text-white flex justify-between items-center">
                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        <tr v-for="asn in asns" :key="asn.id" class="hover:bg-gray-50 dark:bg-white/5 transition-colors">
        ...
        <div v-if="showSlotDetail && selectedSlot"
            ...
            <div class="glass-panel rounded-2xl w-full max-w-md border border-gray-200 dark:border-white/10">
                <div class="p-6 border-b border-gray-100 dark:border-white/5 flex justify-between items-center">
                    ...
                    <button @click="showSlotDetail = false" class="text-gray-500 hover:text-gray-900 dark:text-white"><span
        ...
        <div v-if="showMismatchModal"
            ...
            <div class="glass-panel rounded-2xl w-full max-w-md border border-gray-200 dark:border-white/10">
                <div class="p-6 border-b border-gray-100 dark:border-white/5 flex justify-between items-center">
                    ...
                    <button @click="showMismatchModal = false" class="text-gray-500 hover:text-gray-900 dark:text-white"><span
                            class="material-symbols-outlined">close</span></button>
                </div>
        ...
        <div v-if="showDamageModal"
            ...
            <div class="glass-panel rounded-2xl w-full max-w-md border border-gray-200 dark:border-white/10">
                <div class="p-6 border-b border-gray-100 dark:border-white/5 flex justify-between items-center">
                    ...
                    <button @click="showDamageModal = false" class="text-gray-500 hover:text-gray-900 dark:text-white"><span
                            class="material-symbols-outlined">close</span></button>
                </div>
                <div class="p-6 space-y-4">
                    <div>
                    ...
                    <div>
                        <label class="text-xs text-gray-600 dark:text-gray-400 mb-1 block">Damaged Items Count</label>
                        <input type="number" v-model.number="damageForm.count" placeholder="0"
                            class="w-full bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-lg p-3 text-gray-900 dark:text-white focus:outline-none focus:border-primary/50" />
                    </div>
                    <div>
                        <label class="text-xs text-gray-600 dark:text-gray-400 mb-1 block">Damage Description</label>
        ...
        <div v-if="showScheduleModal"
            ...
            <div class="glass-panel rounded-2xl w-full max-w-md border border-gray-200 dark:border-white/10">
                <div class="p-6 border-b border-gray-100 dark:border-white/5 flex justify-between items-center">
                    <h3 class="font-bold text-gray-900 dark:text-white text-lg">Schedule Inbound Delivery</h3>
                    <button @click="showScheduleModal = false" class="text-gray-500 hover:text-gray-900 dark:text-white"><span
                            class="material-symbols-outlined">close</span></button>
                </div>
                <div class="p-6 space-y-4">
                    <div>
                        <label class="text-xs text-gray-600 dark:text-gray-400 mb-1 block">Supplier Name</label>
                        <input type="text" v-model="scheduleForm.supplier" placeholder="Supplier name"
                            class="w-full bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-lg p-3 text-gray-900 dark:text-white focus:outline-none focus:border-primary/50" />
                    </div>
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="text-xs text-gray-600 dark:text-gray-400 mb-1 block">Expected Qty</label>
