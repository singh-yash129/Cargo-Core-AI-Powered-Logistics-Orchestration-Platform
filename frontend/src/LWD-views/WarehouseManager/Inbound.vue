...
async function fetchInboundShipments() {
    ...
    try {
        ...
        // const response = await fetch(`http://localhost:8000/api/v1/inbound?warehouse_id=${warehouseId}`, {
        //     headers: {
        ...
        // if (!response.ok) {
        //     throw new Error(`Failed to fetch inbound shipments: ${response.statusText}`)
        // }

        // const data = await response.json()
        // dockSchedule.value = data.dock_schedule || []
        // asns.value = data.asns || []
