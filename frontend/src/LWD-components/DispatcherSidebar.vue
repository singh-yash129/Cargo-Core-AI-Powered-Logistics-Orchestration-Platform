<template>
    <aside class="w-64 h-screen bg-card-darker border-r border-white/5 flex flex-col fixed left-0 top-0 z-50">
        <!-- Logo area -->
        <div class="h-16 flex items-center px-6 border-b border-white/5 bg-primary/5">
            <div class="text-xl font-bold text-white tracking-wide">Quad<span class="text-primary">Dispatch</span></div>
        </div>
