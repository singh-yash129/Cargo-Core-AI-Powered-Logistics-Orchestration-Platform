<template>
    <BaseModal :is-open="isOpen" @close="$emit('close')">
        ...
        <div v-if="driver" class="space-y-6">
            ...
            <!-- Current Status -->
            <div class="p-4 bg-gray-50 dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/5 space-y-3">
                <div
                    ...
                    <span class="text-gray-900 dark:text-white">{{ driver.currentJob }}</span>
                </div>
                <div
                    class="flex justify-between items-center text-sm border-b border-gray-200 dark:border-white/5 pb-2">
            ...
            <div class="grid grid-cols-2 gap-3">
                <button
                    class="flex items-center justify-center gap-2 py-2.5 bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 rounded-lg text-sm text-gray-700 dark:text-white transition-colors border border-gray-200 dark:border-white/5">
