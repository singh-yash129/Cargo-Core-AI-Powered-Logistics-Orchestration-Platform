    ...
    <div class="relative">
        <button @click="toggle"
            ...
            <span v-if="unreadCount > 0"
                class="absolute top-2 right-2 w-2 h-2 rounded-full bg-red-500 border border-white dark:border-background-dark animate-pulse"></span>
        </button>

        <!-- Popover -->
        <div v-if="isOpen"
            class="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-card-dark border border-gray-200 dark:border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden transform transition-all origin-top-right">
            <div
                class="p-3 border-b border-gray-200 dark:border-white/10 flex justify-between items-center bg-gray-50 dark:bg-white/5">
                ...
                <div v-for="notif in notifications" :key="notif.id"
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-start">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white line-clamp-1">{{ notif.title }}
                            </h4>
            ...
            <div class="p-2 border-t border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 text-center">
