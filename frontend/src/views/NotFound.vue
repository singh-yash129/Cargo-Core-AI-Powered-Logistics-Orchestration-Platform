<template>
    <div
        ...
        <div class="absolute inset-0 pointer-events-none overflow-hidden flex items-center justify-center opacity-20">
            ...
            <div class="w-[600px] h-[600px] bg-blue-500/20 rounded-full blur-[100px] absolute -bottom-40 -right-60">
            </div>
        </div>

        <div class="max-w-xl w-full text-center relative z-10 px-4">
            <div
                class="mb-8 font-poppins text-[120px] sm:text-[180px] font-black leading-none text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-500 flex justify-center items-center drop-shadow-xl select-none">
                404
            </div>
            ...
            <div class="loader" style="margin-bottom: 40px;">
                <svg class="legl" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20.69332" height="68.19944"
                    ...
                    <g transform="translate(-201.44063,-235.75466)">
                        <g stroke-miterlimit="10">
                            ...
                            <path d="" fill-opacity="0.26667" fill="#97affd" stroke-opacity="0.48627" stroke="#ffffff"
                                stroke-width="0"></path>
                            <path
                        ...
                        <g transform="translate(-164.41679,-112.94712)">
                            <g stroke-miterlimit="10">
                                <path
                                    ...
                                    fill="#191e2e" stroke="#000000" stroke-width="5" stroke-linecap="butt"></path>
                                <path
                                    ...
                                    fill="#191e2e" stroke="none" stroke-width="0" stroke-linecap="butt"></path>
                                <path d="" fill="#ffffff" stroke="none" stroke-width="0.5" stroke-linecap="butt"></path>
                                <path d="" fill-opacity="0.26667" fill="#97affd" stroke-opacity="0.48627"
                                ...
                                <path
                                    ...
                                    fill="none" stroke="#2f3a50" stroke-width="3" stroke-linecap="round"></path>
                            </g>
                        </g>
                    </svg>
                        ...
                        <g transform="translate(-191.87889,-75.62023)">
                            <g stroke-miterlimit="10">
                                ...
                                <path
                                    ...
                                    fill="none" stroke="#2f3a50" stroke-width="6" stroke-linecap="butt"></path>
                                <path
                                    ...
                                    fill="#191e2e" stroke-opacity="0.48627" stroke="#ffffff" stroke-width="0"
                                    stroke-linecap="butt"></path>
                                <path d="M271.10348,122.46768l10.06374,-3.28166l24.06547,24.28424" fill="none"
                                    stroke="#2f3a50" stroke-width="6" stroke-linecap="round"></path>
                                <path d="M306.56448,144.85764l-41.62024,-8.16845l2.44004,-7.87698" fill="none"
                                    stroke="#94a3b8" stroke-width="3.5" stroke-linecap="round"></path>
                                <path
                ...
                <svg id="gnd" version="1.1" xmlns="http://www.w3.org/2000/svg" width="475" height="530"
                    ...
                    <g transform="translate(-176.25,-207.64957)">
                        <g stroke="#2d3748" stroke-width="2.5" stroke-linecap="round" stroke-miterlimit="10">
                            <path
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <button @click="goHome"
                    class="w-full sm:w-auto px-6 py-3 rounded-xl font-medium bg-primary text-white hover:bg-primary/90 transition-colors transform hover:scale-105 duration-200 shadow-xl shadow-primary/30 flex items-center justify-center gap-2">
