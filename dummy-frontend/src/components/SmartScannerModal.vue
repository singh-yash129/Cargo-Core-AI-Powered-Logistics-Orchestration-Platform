<template>
    <Teleport to="body">
        <div v-if="isOpen"
            class="fixed inset-0 w-screen h-screen z-[9999] flex items-center justify-center animate-fade-in px-4">
            <!-- Backdrop -->
            <div class="absolute inset-0 w-full h-full bg-black/60 backdrop-blur-sm" @click="closeModal"></div>
                    ...
                    <div v-if="activeTab === 'scan'" class="text-center space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                Point your hardware scanner at the barcode and scan. The system will automatically
                                detect
                                the input.
                            </p>
                        </div>
                    ...
                    <div v-if="activeTab === 'camera'" class="text-center space-y-4">
                        <div
                            ...
                            <div v-if="!photoData" class="absolute inset-4 pointer-events-none z-20">
                                <div class="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-primary/50">
                                </div>
                                <div class="absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-primary/50">
                                </div>
                                <div class="absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 border-primary/50">
                                </div>
