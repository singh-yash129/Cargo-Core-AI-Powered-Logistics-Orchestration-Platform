        ...
        <div class="glass-panel rounded-xl overflow-hidden p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div v-for="user in displayedUsers" :key="user.email"
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <div
                                class="font-bold text-gray-900 dark:text-white text-lg leading-tight flex items-center gap-1.5">
                                {{ user.name }}
                                <span v-if="user.mobileVerified && user.emailVerified"
                                    class="text-green-500 material-symbols-outlined text-[18px]"
                            ...
                            <div class="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1 mt-0.5">
                                ...
                                <span v-else
                                    class="text-[10px] bg-red-100 dark:bg-red-500/10 text-red-600 dark:text-red-400 px-1.5 py-0.5 rounded uppercase font-bold tracking-wider">Unverified</span>
                            </div>
                    ...
                    <div
                        ...
                        <div class="p-6 overflow-y-auto space-y-4 max-h-[70vh]">
                            ...
                            <template
                                ...
                                <div
                                    class="bg-gray-50/50 dark:bg-white/5 p-4 rounded-xl border border-gray-200 dark:border-white/10 space-y-4 shadow-sm relative overflow-hidden group">
                                    <div
                                    ...
                                    <div class="grid grid-cols-2 gap-4 relative z-10 mt-3">
                                        <div class="col-span-2 md:col-span-1">
                                            ...
                                            <input v-model="formData.name" type="text" placeholder="e.g. John Doe"
                                                class="w-full bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg px-4 py-2.5 text-[13px] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium">
                                        </div>
                                        <div class="col-span-2 md:col-span-1">
                                            <label
                                        ...
                                        <div class="col-span-2 md:col-span-1">
                                            ...
                                            <input v-model="formData.email" type="email"
                                                ...
                                                class="w-full bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg px-4 py-2.5 text-[13px] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium disabled:opacity-60 disabled:cursor-not-allowed">
                                        </div>
                                        <div class="col-span-2 md:col-span-1">
                                            <label class="flex justify-between items-center mb-1">
                                                <span
                                            ...
                                            <input v-model="formData.mobile" @input="formatField('mobile')" type="tel"
                                                ...
                                                class="w-full bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg px-4 py-2.5 text-[13px] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium tracking-wide">
                                        </div>
                                        <div class="col-span-2 md:col-span-1">
                                            <label
                                            ...
                                            <div class="relative items-center">
                                                <select v-model="formData.bloodGroup"
                                                    class="w-full bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg px-4 py-2.5 text-[13px] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium appearance-none">
                                                    <option
                                    ...
                                    <div class="grid grid-cols-2 gap-4 relative z-10 mt-3">
                                        <div class="col-span-2 md:col-span-1">
                                            ...
                                            <input v-model="formData.aadharCard" @input="formatField('aadharCard')"
                                                ...
                                                class="w-full bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg px-4 py-2.5 text-[13px] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium uppercase font-mono tracking-wider">
                                        </div>
                                        <div class="col-span-2 md:col-span-1">
                                            <label
                                        ...
                                        <div class="col-span-2 md:col-span-1">
                                            ...
                                            <input v-model="formData.bankAccount" @input="formatField('bankAccount')"
                                                ...
                                                class="w-full bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg px-4 py-2.5 text-[13px] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium font-mono tracking-wider">
                                        </div>
                                        <div class="col-span-2 md:col-span-1">
                                            <label
            ...
            <Teleport to="body">
                <div v-if="isOtpModalOpen"
                    ...
                    <div
                        class="bg-white dark:bg-card-dark w-full max-w-sm rounded-2xl shadow-2xl border border-gray-200 dark:border-white/10 overflow-hidden text-center p-6 relative">
                        ...
                        <input v-model="otpValue" type="text" maxlength="4" placeholder="••••" @keyup.enter="verifyOtp"
                            class="w-32 bg-gray-50 dark:bg-black/20 text-center text-3xl tracking-widest border border-gray-200 dark:border-white/10 rounded-lg px-4 py-3 mx-auto text-gray-900 dark:text-white focus:outline-none focus:border-primary/50 transition-colors mb-2 font-mono">
