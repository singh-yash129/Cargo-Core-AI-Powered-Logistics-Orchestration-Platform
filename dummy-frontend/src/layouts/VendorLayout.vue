                ...
                <div v-if="showAddFundsModal"
                    ...
                    <div
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Top up your vendor credit balance.
                            </p>
                            ...
                            <div class="space-y-4 mb-6">
                                ...
                                <div class="flex gap-2">
                                    <button v-for="amt in [5000, 10000, 50000]" :key="amt" @click="addAmount = amt"
                            ...
                            <div class="flex gap-3">
                                ...
                                <button @click="submitAddFunds" :disabled="!addAmount || addAmount <= 0"
                                    ...
                                    ${{ (addAmount || 0).toLocaleString() }}</button>
                            </div>
                        </div>
                    </div>
                </div>
